...
public class SupportDto {
    ...
    public SupportDto(Integer id, String ticket, String category, String question, String answer, String urlPhoto, State state, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.ticket = ticket;
